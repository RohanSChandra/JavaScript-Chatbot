...
function compatibilityCheck(name, declared, options) {
    const { silent, version: current, logger } = Object.assign(Object.assign({}, defaults$p), options);
...
class ElementName extends Rule {
    ...
    documentationMessages(context) {
        ...
        if (context.pattern !== defaults$e.pattern) {
            return [
...
class TextContent$1 extends Rule {
    documentation(context) {
        const doc = {
    ...
    static filter(event) {
        ...
        if (!textContent || textContent === TextContent.DEFAULT) {
            return false;
        }
        return true;
    }
    setup() {
        this.on("element:ready", TextContent$1.filter, (event) => {
            const target = event.target;
            const { textContent } = target.meta;
            switch (textContent) {
                case TextContent.NONE:
...
class H37 extends Rule {
    constructor(options) {
        super(Object.assign(Object.assign({}, defaults$1), options));
...
export { Config as C, DynamicValue as D, EventHandler as E, HtmlValidate as H, MetaTable as M, NodeClosed as N, Parser as P, Rule as R, Severity as S, TextNode as T, UserError as U, ConfigError as a, ConfigLoader as b, HtmlElement as c, SchemaValidationError as d, MetaCopyableProperty as e, Reporter as f, TemplateExtractor as g, getFormatter as h, compatibilityCheck as i, bugs as j, TokenType as k, legacyRequire as l, name as n, presets as p, ruleExists as r, version as v };
